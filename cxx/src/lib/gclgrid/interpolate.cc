...
void compute_element_weights(const GCLgrid3d *g,
...
double *GCLvectorfield::interpolate(const double xp1, const double xp2, const double xp3)
{
	double coord[24];
	int l;
	/* This depends on a static being initialized once on first call */
...
double GCLscalarfield::interpolate(const double xp1, const double xp2, const double xp3)
{
	double coord[24];
	/* This depends on a static being initialized once on first call */
	static double xplast[3]={0.0,0.0,0.0};

...
public:
    ...
    */
    RegionalCoordinates(const double olat, const double olon, const double oradius, const double azn);
    ...
    /*! Return cartesian coordinates of a geographic point.
       ...
       */
    pwmig::gclgrid::Cartesian_point  cartesian(const double lat,
    ...
    pwmig::gclgrid::Cartesian_point
       cartesian(const pwmig::gclgrid::Geographic_point gp) const;
    /*! \brief Return cartesian coordinates of a geographic point.
      ...
      \param x - is a 3 vector holding Geographic point data to
        ...
        */
    pwmig::gclgrid::Cartesian_point cartesian(const double x[3]) const;
    ...
    */
    pwmig::gclgrid::Geographic_point geographic
    ...
    \return converted point in Geographic_point struct (radians and km units)
    */
    pwmig::gclgrid::Geographic_point geographic(const double x[3]) const;
    /* \brief Return geographic point description of cartesian input.
    ...
    \return converted point in Geographic_point struct (radians and km units)
    */
    pwmig::gclgrid::Geographic_point geographic(const Cartesian_point cp) const;
    /*! Return the origin of the coordinate system. */
    pwmig::gclgrid::Geographic_point origin() const;
    /*! Return the azimuth of the coordinate system which is the angle
      ...
      */
    double aznorth_angle() const{return(azimuth_y);};
    /*! \brief Return transformation matrix to convert local azimuth to cartesian system.
      ...
      \param lon - longitude in radians of the point to compute the
              transformation matrix.
              */
    mspass::utility::dmatrix l2rtransformation(const double lat, const double lon) const;
private:

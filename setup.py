# This setup.py file was blantly copied and modified from the 
# comparable file in mspass.  Appropriate since I (glp) cloned the 
# directory structure of mspass to build this package
# May need a cleaner link to mspass
...
dir_util.copy_tree("data", "python/pwmigpy/data")
